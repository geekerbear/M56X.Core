...
namespace M56X.Core.Helper
{
    public partial class RegexHelper
    {
        ...
        */
        ...
        {
            return IsPhoneNumberRegex().IsMatch(strPhoneNumber);
        }
        #endregion
        ...
        {
            return IsAllNumericRegex().IsMatch(str);
        }
        #endregion
        ...
        {
            return IsPositiveNumRegex().IsMatch(str);
        }
        #endregion
        ...
        {
            return IsChineseNameRegex().IsMatch(cnName);
        }
        ...
        {
            return IsChineseOrEnglishNameRegex().IsMatch(name);
        }
        ...
        {
            return IsChineseCharRegex().IsMatch(str);
        }
        ...
        {
            return IsTimeRegex().IsMatch(time);
        }
        #endregion
        ...
        {
            return IsHexStringRegex().IsMatch(hexString);
        }
        ...
        {
            return IsAbsolutePathRegex().IsMatch(path.Trim().Replace(" ", "").Replace("　", ""));
        }
        ...
        public static bool IsRelativePath(string path)
        {
            ...
            return IsRelativePathRegex().IsMatch(path);

        }

        [GeneratedRegex(@"^[1]+\d{10}$")]
        private static partial Regex IsPhoneNumberRegex();

        [GeneratedRegex(@"^[0-9]*$")]
        private static partial Regex IsAllNumericRegex();
        [GeneratedRegex(@"^\+?[1-9][0-9]*$")]
        private static partial Regex IsPositiveNumRegex();
        [GeneratedRegex(@"^((2[0-4]\d|25[0-5]|[01]?\d\d?)\.){3}(2[0-4]\d|25[0-5]|[01]?\d\d?)$")]
        private static partial Regex IsIPRegex();
        [GeneratedRegex(@"^[\u4e00-\u9fa5]{2,4}$")]
        private static partial Regex IsChineseNameRegex();
        [GeneratedRegex(@"^([\u4e00-\u9fa5]{2,15}|([a-zA-Z]+\s?)+)$")]
        private static partial Regex IsChineseOrEnglishNameRegex();
        [GeneratedRegex(@"^[\u4e00-\u9fa5]+$")]
        private static partial Regex IsChineseCharRegex();
        [GeneratedRegex(@"^[\w-]+(\.[\w-]+)*@[\w-]+(\.[\w-]+)+$")]
        private static partial Regex IsEmailRegex();
        [GeneratedRegex(@"http(s)?://([\w-]+\.?)+[\w-]+(/[\w- ./?%&=]*)?", RegexOptions.IgnoreCase, "zh-CN")]
        ...
        private static partial Regex IsHexStringRegex();
        [GeneratedRegex(@"^[a-zA-Z]:\\[^\\][^\/\:\*\?\""\<\>\|\,]*$")]
        private static partial Regex IsAbsolutePathRegex();
        [GeneratedRegex(@"^[^\\\:\*\?\""\<\>\|\,]*$")]
