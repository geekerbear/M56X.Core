namespace M56X.Core.PinYin.Data
{
    public static class PinyinData
    {
        ...
        /// 汉字 Unicode 编码最小值
        /// </summary>
        internal static char MIN_VALUE = (char)19968;

        /// <summary>
        /// 汉字 Unicode 编码最小值
        /// </summary>
        internal static char MAX_VALUE = (char)40869;

        /// <summary>
        /// 特殊的汉字“〇”，编码为 12295
        /// </summary>
        internal static String PINYIN_12295 = "LING";
        internal static char CHAR_12295 = (char)12295;

        internal static int PINYIN_CODE_1_OFFSET = 7000;

        internal static int PINYIN_CODE_2_OFFSET = 7000 * 2;

        internal static int[] BIT_MASKS = [1, 2, 4, 8, 16, 32, 64, 128];

        internal static short PADDING_MASK = 256;

        //CHECKSTYLE:OFF
        internal static string[] PINYIN_TABLE = ["", "A", "AI", "AN", "ANG", "AO", "BA", "BAI",
